...
import com.example.nhom14_galfourteenth.adapter.ColorPickerAdapter;
...
public class TextEditorDialogFragment extends DialogFragment {
    ...
    private AppCompatButton mAddTextDoneTextView;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mAddTextDoneTextView = view.findViewById(R.id.add_text_done_btn);
